...
import { Edit3, Settings, Handshake } from "lucide-react";
      ...
      <main className="container py-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          <Avatar className="h-28 w-28 ring-4 ring-primary/20 shadow-xl mx-auto mb-4">
            <AvatarFallback className="bg-gradient-to-br from-primary to-[hsl(280,65%,60%)] text-3xl font-bold text-white">{initials}</AvatarFallback>
          </Avatar>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Card className="mb-6">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg flex items-center gap-2"><Handshake className="h-5 w-5 text-primary" />Skills & Interests</CardTitle>
            </CardHeader>
            <CardContent>
